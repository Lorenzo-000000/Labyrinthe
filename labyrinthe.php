...
function flecheVide(string $dir): string {
    return "<span class='fleche vide'><img src='$dir.png' class='fleche-img'></span>";
}
...
$img = ["N"=>"nord.png","S"=>"sud.png","E"=>"est.png","O"=>"ouest.png","SECRET"=>"secret.png"];
...
while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
    ...
    if ($type === "secret") {
        $dirs["SECRET"] = "<a class='fleche secret' href='?position=$dest'><img src='secret.png' class='fleche-img'></a>";
        continue;
    }
...
<style>
body {
    background: url("mid.png") no-repeat center center fixed;
