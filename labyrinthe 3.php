...
<!-- 'select couloir.id, passage.couloir1, passage.couloir2 from passage left join couloir as C1 on passage.couloir1 = c1.id  -->
<!-- left join couloir as c2 on passage.couloir2 = c2.id'; -->
